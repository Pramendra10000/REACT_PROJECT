...
const AngularPage = () => {
    ...
    useEffect(() => {
        const unsub = onSnapshot(collection(db, "AngularQAMaster"), (snap) => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            const checks = [
                query(collection(db, "AngularUsers"), where("username", "==", formData.username)),
                query(collection(db, "AngularUsers"), where("email", "==", formData.email)),
                query(collection(db, "AngularUsers"), where("mobile", "==", formData.mobile)),
                query(collection(db, "AngularUsers"), where("linkedin", "==", formData.linkedin))
            ];
            ...
            await setDoc(doc(collection(db, "AngularUsers")), formData);
        ...
        <div className="angular-page">
            <header>
                ...
                <div className="search-bar">
                    <input
                        type="text"
                        placeholder="Search Angular questions..."
                        value={searchQuery}
