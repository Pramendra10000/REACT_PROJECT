    ...
    <div className="intro">
      <div className="i-left">
        <div className="i-name">
          ...
          <span>
            Full stack Developer Having 3+ Experience In Insurence Domain, With
            Good Skills In Java|Spring MVC|Spring Boot|Servlet|Sql
            Server|Azure|Github|Bootstrap|React.js Producting The Quality Work.
          </span>
        </div>
